...
const DEFAULT_REPO = process.env.OPENCLAW_RELEASE_REPO || "grokbot/grokbot";
const RELEASE_EVIDENCE_SCHEMA = "grokbot.release-validation-evidence/v3";
...
function downloadParentManifestEvidence(runId, runAttempt, repository, manifestPath) {
  ...
  const downloadDir = mkdtempSync(join(tmpdir(), "grokbot-release-ci-summary-"));
  try {
