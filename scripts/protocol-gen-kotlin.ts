// Protocol Gen Kotlin script supports GrokBot repository automation.
...
const gatewayOutputPath = path.join(
  repoRoot,
  "apps/android/app/src/main/java/ai/grokbot/app/gateway/GatewayProtocol.kt",
);
const constantsOutputPath = path.join(
  repoRoot,
  "apps/android/app/src/main/java/ai/grokbot/app/protocol/OpenClawProtocolConstants.kt",
);
...
async function generate(): Promise<void> {
  ...
  const gatewayContent = [
    ...
    "package ai.grokbot.app.gateway",
    "",
  ...
  const constantsContent = [
    "// Generated by scripts/protocol-gen-kotlin.ts — do not edit by hand.",
    "package ai.grokbot.app.protocol",
    "",
