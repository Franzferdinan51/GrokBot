...
IMAGE_NAME="$(docker_e2e_resolve_image "grokbot-session-runtime-context-e2e" OPENCLAW_SESSION_RUNTIME_CONTEXT_E2E_IMAGE)"
CONTAINER_NAME="grokbot-session-runtime-context-e2e-$$"
RUN_LOG="$(mktemp -t grokbot-session-runtime-context-log.XXXXXX)"
