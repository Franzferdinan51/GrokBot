...
IMAGE_NAME="$(docker_e2e_resolve_image "grokbot-commitments-safety-e2e" OPENCLAW_COMMITMENTS_SAFETY_E2E_IMAGE)"
CONTAINER_NAME="grokbot-commitments-safety-e2e-$$"
RUN_LOG="$(mktemp -t grokbot-commitments-safety-log.XXXXXX)"
