...
IMAGE_NAME="$(docker_e2e_resolve_image "grokbot-mcp-channels-e2e" OPENCLAW_IMAGE)"
PORT="18789"
TOKEN="mcp-e2e-$(date +%s)-$$"
CONTAINER_NAME="grokbot-mcp-e2e-$$"
CLIENT_LOG="$(mktemp -t grokbot-mcp-client-log.XXXXXX)"
