...
// Summarizes GrokBot performance source fixtures for reports.
...
function printHelp() {
  console.log(`Usage: node scripts/grokbot-performance-source-summary.mjs --source-dir <dir> [--baseline-source-dir <dir>] [--output <summary.md>]

Summarizes GrokBot-native performance probe artifacts for CI reports.`);
}
