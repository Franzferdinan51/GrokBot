...
export function buildDeprecatedPluginSdkModuleSpecifiers(
  ...
  const unscoped = [
    ...
    ...deprecatedSubpaths.map((subpath) => `grokbot/plugin-sdk/${subpath}`),
  ];
  // tsconfig aliases the scoped @grokbot/plugin-sdk package to the same
...
export const BANNED_INTERNAL_PLUGIN_SDK_FACADE_MODULES = [
  // Reply facades: canonical seams are grokbot/plugin-sdk/channel-inbound and
  // grokbot/plugin-sdk/channel-outbound (defineChannelMessageAdapter family).
  {
    modulePath: "src/plugin-sdk/channel-message",
    canonical: "grokbot/plugin-sdk/channel-outbound",
  },
  {
  ...
  },
  {
    ...
    canonical: "grokbot/plugin-sdk/channel-inbound",
  },
  {
