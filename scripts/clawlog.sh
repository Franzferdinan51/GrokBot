...
show_usage() {
    cat << EOF
clawlog - GrokBot Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View GrokBot logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    GrokBot logs flow through the macOS unified log (subsystem: ai.grokbot).
