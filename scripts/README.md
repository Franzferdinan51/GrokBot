...
| Commits         | `scripts/committer "<message>" <files...>`                                     | Preferred scoped commit helper for GrokBot changes.                                                               |
...
- `release-*`, `grokbot-npm-*`, and `plugin-*-release-*`: release preparation,
...
See also [Scripts](https://docs.grokbot.ai/help/scripts) for public-facing script guidance.
