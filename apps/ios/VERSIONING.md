# GrokBot iOS Versioning

GrokBot iOS release uploads use an explicit CalVer release version. The
...
```text
refs/grokbot/mobile-releases/ios/<CFBundleShortVersionString>-<CFBundleVersion>
```

Example:

```text
refs/grokbot/mobile-releases/ios/2026.6.11-3
```
