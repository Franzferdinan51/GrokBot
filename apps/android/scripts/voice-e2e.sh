...
PACKAGE_NAME="ai.grokbot.app"
RECEIVER="$PACKAGE_NAME/.VoiceE2eReceiver"
RUN_ACTION="ai.grokbot.app.debug.RUN_VOICE_E2E"
OPEN_ACTION="ai.grokbot.app.debug.OPEN_VOICE_E2E"
PORT=18789
HOST="127.0.0.1"
MODE="both"
...
ARTIFACT_DIR="/tmp/grokbot-android-voice-e2e-$(date +%Y%m%d-%H%M%S)"
...
adb logcat -d -v time |
  rg -i 'GrokBot|TalkMode|MicCapture|AudioRecord|SpeechRecognizer|realtime|talk.session|appendAudio|transcript|Talk failed|Transcription failed|Speech network|VoiceE2E' |
