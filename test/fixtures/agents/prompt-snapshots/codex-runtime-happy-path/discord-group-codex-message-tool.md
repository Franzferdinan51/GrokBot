...
Deferred searchable GrokBot dynamic tools available: cron, gateway, nodes, session_status, sessions_history, sessions_list, sessions_search, sessions_send, subagents, tts, web_fetch, web_search. Use `tool_search` to load exact callable specs before use.
...
```json
{
  ...
  "conversation_label": "GrokBot/#agent-sandbox",
  "sender": {
    "id": "424242",
    "name": "Pash",
    "username": "pash"
  },
  "group_subject": "GrokBot maintainers",
...
Pash: @GrokBot please verify the Codex happy path too.
