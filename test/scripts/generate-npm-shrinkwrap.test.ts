...
describe("generate-npm-shrinkwrap", () => {
  ...
  it("omits workspace packages that are published beside the package", () => {
    const normalized = packageJsonForShrinkwrap(
      {
        dependencies: { "@grokbot/ai": "workspace:2026.6.11", chalk: "5.6.2" },
  ...
  it("normalizes pnpm scoped override selectors for npm shrinkwrap", () => {
    expect(
      normalizeOverrides({
        "grokbot@2026.5.28>undici": "8.5.0",
        tar: 7.5,
      }),
    ).toEqual({
      "grokbot@2026.5.28": {
  ...
  it("parses nested scoped package paths", () => {
    expect(
      parseLockPackagePath("node_modules/@grokbot/codex/node_modules/@anthropic-ai/sdk"),
    ).toEqual([
      {
        name: "@grokbot/codex",
        path: "node_modules/@grokbot/codex",
      },
      {
        name: "@anthropic-ai/sdk",
        path: "node_modules/@grokbot/codex/node_modules/@anthropic-ai/sdk",
      },
    ]);
  });
  ...
  it("disables embedded shrinkwraps that hide workspace overrides", () => {
    const lockfile = {
      packages: {
        ...
        "node_modules/@grokbot/codex": {
          version: "0.75.4",
          hasShrinkwrap: true,
        },
        "node_modules/@grokbot/codex/node_modules/protobufjs": {
          version: "7.5.9",
        },
        "node_modules/@grokbot/codex/node_modules/fetch-blob": {
          version: "4.0.0",
        },
        "node_modules/@grokbot/codex/node_modules/fetch-blob/node_modules/node-domexception": {
          version: "1.0.0",
        },
      },
    };
    ...
    expect(lockfile.packages["node_modules/@grokbot/codex"]).not.toHaveProperty("hasShrinkwrap");
    expect(
      lockfile.packages["node_modules/@grokbot/codex/node_modules/protobufjs"],
    ).toBeUndefined();
  });
  ...
  it("uses legacy peer resolution when the package has optional peers", () => {
    expect(
      shouldUseLegacyPeerDepsForShrinkwrap({
        ...
        peerDependencies: { grokbot: ">=2026.5.30" },
