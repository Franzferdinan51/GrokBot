...
const resolverPath = path.resolve("scripts/secrets/grokbot-bws-resolver.mjs");

function makeTempDir(): string {
  const dir = mkdtempSync(path.join(tmpdir(), "grokbot-bws-resolver-"));
  tempDirs.push(dir);
  return dir;
}
