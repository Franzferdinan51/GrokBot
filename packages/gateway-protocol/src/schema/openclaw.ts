// Gateway Protocol schema module defines GrokBot chat payloads.
...
/**
 * GrokBot chat lets clients (macOS app onboarding, future UIs) hold the
...
/** One GrokBot reply; `action` tells clients about conversation handoffs. */
