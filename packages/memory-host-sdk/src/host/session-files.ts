...
import { createSubsystemLogger, redactSensitiveText } from "./grokbot-runtime-io.js";
import {
...
function isDreamingNarrativeBootstrapRecord(record: unknown): boolean {
  ...
  if (
    ...
    candidate.customType !== "grokbot:bootstrap-context:full" ||
    !candidate.data ||
 ...
 * GrokBot-owned usage-counted transcript in the canonical agent sessions dir.
 */
...
/**
 * Strip GrokBot-injected inbound metadata envelopes from a raw text block.
 *
 ...
 * impossible.
 *
 * See: https://github.com/grokbot/grokbot/issues/63921
 */
