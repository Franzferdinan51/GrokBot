...
/** Provider API families with first-class request/stream adapters in GrokBot. */
...
/** Image-generation API families with first-class adapters in GrokBot. */
...
/** Image provider ids with first-class adapters in GrokBot. */
...
export interface UserMessage {
   ...
   * (e.g. an GrokBot runtime-context carrier appended after the active user
...
export interface Model<TApi extends Api = Api> {
  ...
  reasoning: boolean;
  /**
   * Maps GrokBot thinking levels to provider/model-specific values.
