// Projects ACP runtime events into GrokBot-visible session update records.
import type { AcpRuntimeEvent, AcpSessionUpdateTag } from "@grokbot/acp-core/runtime/types";
import {
