 ...
 */
const RECENT_QUEUE_MESSAGE_IDS_KEY = Symbol.for("grokbot.recentQueueMessageIds");
...
if (process.env.VITEST === "true" || process.env.NODE_ENV === "test") {
  (globalThis as Record<PropertyKey, unknown>)[Symbol.for("grokbot.queueEnqueueTestApi")] = {
