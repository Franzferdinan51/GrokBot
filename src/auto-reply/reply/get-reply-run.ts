...
import { type FastMode, normalizeOptionalString } from "@grokbot/normalization-core/string-coerce";
import {
  ...
  const userTurnInput =
    userTurnTranscriptText !== undefined || userTurnMediaForPersistence.length > 0
      ? {
          ...
          // replayed as history. See: https://github.com/grokbot/grokbot/issues/3658
