...
import { formatErrorMessage as formatSharedErrorMessage } from "@grokbot/normalization-core/error-coercion";
...
export { stringifyNonErrorCause, toErrorObject } from "@grokbot/normalization-core/error-coercion";
