...
import { resolveOpenClawPackageRoot, resolveOpenClawPackageRootSync } from "./grokbot-root.js";
...
async function resolveControlUiDistIndexPath(
  ...
  // Fallback: traverse up and find package.json with name "grokbot" + dist/control-ui/index.html
...
export function resolveControlUiRootSync(opts: ControlUiRootResolveOptions = {}): string | null {
  ...
  if (argv1RealpathDir && argv1RealpathDir !== argv1Dir) {
    // Symlinked wrappers (e.g. ~/.bun/bin/grokbot -> .../dist/index.js)
