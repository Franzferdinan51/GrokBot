...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("grokbot.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("grokbot.contextEngineRegistryState");
