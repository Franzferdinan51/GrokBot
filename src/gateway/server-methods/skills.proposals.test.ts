...
describe("skills proposal gateway handlers", () => {
  beforeEach(async () => {
    testState = await createOpenClawTestState({
      layout: "state-only",
      prefix: "grokbot-skills-proposals-gateway-state-",
    });
    ...
    mocks.workspaceDir = await tempDirs.make("grokbot-skills-proposals-gateway-");
  ...
  it("scopes list and inspect to the resolved agent workspace", async () => {
    ...
    const secondWorkspaceDir = await tempDirs.make("grokbot-skills-proposals-gateway-second-");
