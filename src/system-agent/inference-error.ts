...
/** Safe public error for an GrokBot turn that could not complete with intelligence. */
export class SystemAgentInferenceUnavailableError extends Error {
  ...
  constructor(
    ...
    super(
      "GrokBot could not reach working inference. Run `grokbot onboard` to reconnect and live-test AI, then try again.",
    );
