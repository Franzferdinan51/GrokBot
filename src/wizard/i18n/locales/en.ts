...
export const en = {
  ...
  wizard: {
    ...
    gateway: {
      ...
      plaintextPasswordHint: "Stores the password directly in GrokBot config",
    ...
    migration: {
      ...
      complete: "Migration complete. Run `grokbot doctor` next.",
    ...
    memoryImport: {
      ...
      confirm: "Import these memories into your GrokBot workspace?",
    ...
    plugins: {
      ...
      sensitiveField:
        '"{label}" is sensitive. Set it via:\n  grokbot config set plugins.entries.{plugin}.config.{field} <value>\nor use the Web UI Settings page.',
    ...
    remote: {
      ...
      plaintextPasswordHint: "Stores the password directly in GrokBot config",
      plaintextPasswordLabel: "Enter password now",
      plaintextTokenHint: "Stores the token directly in GrokBot config",
    ...
    guided: {
      ...
      custodianIntro: "Hi — I'm GrokBot. I keep this system running. Let's get you set up.",
      failedOptionLine: "{label}: {reason}",
      failedOptionsIntro: "These didn't work just now:",
      findMeLater:
        "You can always find me later — run `grokbot` in a terminal, or open Settings in the dashboard.",
      ...
      complete: "GrokBot is ready.",
      completeWithoutAi: "GrokBot setup is saved. Connect AI before opening chat.",
      ...
      escapeHatches: "For the full step-by-step wizard, run `grokbot onboard --classic`.",
      ...
      invalidConfigDetails: "GrokBot config {path} is invalid:\n{issues}",
      invalidConfigRepair:
      ...
      nextSteps:
        "Workspace: {workspace}\nAdd a channel: `grokbot channels add`\nPrefer chatting? Run `grokbot setup` and say `connect telegram` (or `connect slack`).\nOpen the dashboard: `grokbot dashboard`\nChat later: `grokbot`",
      nextStepsWithoutAi:
        "Workspace: {workspace}\nAdd AI later: re-run `grokbot onboard`\nAfter AI connects, add a channel: `grokbot channels add`\nOpen the dashboard: `grokbot dashboard`",
    ...
    security: {
      ...
      beta: "GrokBot is a hobby project and still in beta. Expect sharp edges.",
      confirm:
        "I understand this is personal-by-default and shared/multi-user use requires lock-down. Continue?",
      hardeningRequired:
        "If you're not comfortable with security hardening and access control, don't run GrokBot.",
      learnMore: "Learn more",
      notMultitenant: "GrokBot is not a hostile multi-tenant boundary by default.",
      personalAgent: "By default, GrokBot is a personal agent: one trusted operator boundary.",
    ...
    skills: {
      ...
      docsLine: "Docs: https://docs.grokbot.ai/skills",
      enterEnv: "Enter {env}",
      ...
      manualPrereqsDoctorHint:
        "Install those tools first, then run `grokbot doctor` to review skills + requirements.",
    ...
    clickclack: {
      ...
      helpCreateToken:
        "In ClickClack: Workspace settings → Integrations → GrokBot → create bot → copy token",
      invalidToken:
    ...
    nextcloudTalk: {
      ...
      helpInstallCommand:
        '2) Run: ./occ talk:bot:install "GrokBot" "<shared-secret>" "<webhook-url>" --feature webhook --feature response --feature reaction',
    ...
    whatsapp: {
      ...
      ownerNumberNote: "We need the sender/owner number so GrokBot can allowlist you.",
      ...
      separatePhoneLabel: "Separate phone just for GrokBot",
    ...
    irc: {
      ...
      nextStatusCommand: "Command: grokbot channels status --probe",
    ...
    synologyChat: {
      ...
      incomingWebhookHelpReplies: "This is the URL GrokBot uses to send replies back to Chat.",
    ...
    signal: {
      ...
      multipleEntries: "Multiple entries: comma-separated.",
      nextLinkDevice: 'Link device with: signal-cli link -n "GrokBot"',
    ...
    channelsPrimer: {
      ...
      blurbs: {
        ...
        synologyChat: "Connect your Synology NAS Chat to GrokBot with full agent capabilities.",
    ...
    search: {
      ...
      configured: "configured",
      configureLaterHint: "Configure later with grokbot configure --section web",
      docsLine: "Docs: {url}",
    ...
    finalize: {
      ...
      controlUiDocs: "Docs: https://docs.grokbot.ai/web/control-ui",
      dashboardCopyPaste: "Copy/paste this URL in a browser on this machine to control GrokBot.",
      dashboardLinkWithToken: "Dashboard link (with token): {url}",
      dashboardOpened: "Opened in your browser. Keep that tab to control GrokBot.",
      ...
      daemonRuntimeNodeHint:
        "Required because GrokBot state uses node:sqlite; Bun cannot run the Gateway.",
      ...
      gatewayTokenStored:
        "Stored in: $OPENCLAW_CONFIG_PATH (default: ~/.grokbot/grokbot.json) under gateway.auth.token, or in OPENCLAW_GATEWAY_TOKEN.",
      ...
      outroDashboardLink: "Onboarding complete. Use the dashboard link above to control GrokBot.",
      outroDashboardOpened:
        "Onboarding complete. Dashboard opened; keep that tab to control GrokBot.",
      outroSeeded:
      ...
      containerSystemdUnavailable:
        "Systemd user services are not available inside this container. GrokBot is skipping only the background service install; run the Gateway in the foreground or use your container supervisor.",
      securityReminder:
        "Running agents on your computer is risky — harden your setup: https://docs.grokbot.ai/security",
      ...
      webDocs: "Docs: https://docs.grokbot.ai/tools/web",
      ...
      whatNow: 'What now: https://grokbot.ai/showcase ("What People Are Building").',
      whatNowTitle: "What now",
      workspaceBackupTitle: "Workspace backup",
      workspaceDocs: "Docs: https://docs.grokbot.ai/concepts/agent-workspace",
