...
export const SKILL_WORKSHOP_SCHEMA = "grokbot.skill-workshop.proposal.v1" as const;
export const SKILL_WORKSHOP_MANIFEST_SCHEMA =
  "grokbot.skill-workshop.proposals-manifest.v1" as const;
export const SKILL_WORKSHOP_ROLLBACK_SCHEMA = "grokbot.skill-workshop.rollback.v1" as const;
