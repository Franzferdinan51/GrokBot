...
/** Runtime adapter that lets the package agent-core use GrokBot LLM helpers. */
...
/** Agent-core class preconfigured with GrokBot runtime dependencies. */
...
// GrokBot-owned reusable agent core
