...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://grokbot.local")).toBe("https://grokbot.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://grokbot.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: grokbot security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://grokbot.local" },
      ...
      { Item: "Security", Value: "Run: grokbot security audit --deep" },
