...
export async function setupCommand(
  ...
  runtime.log(`Next guided path: ${formatCliCommand("grokbot onboard")}.`);
  runtime.log(
    `Next targeted changes: ${formatCliCommand("grokbot configure")} for models, channels, Gateway, plugins, skills, and health checks.`,
  );
  runtime.log(`Add a chat channel later: ${formatCliCommand("grokbot channels add")}.`);
}
