 ...
 * pairs directly into the provider payload, so GrokBot must normalize here.
 */
 ...
 *
 * GrokBot persists provider-specific reasoning metadata in `thinkingSignature`; if that metadata
