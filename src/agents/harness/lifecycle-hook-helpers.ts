...
import { normalizeOptionalString as normalizeTrimmedString } from "@grokbot/normalization-core/string-coerce";
...
const FINALIZE_RETRY_BUDGET_KEY = Symbol.for("grokbot.pluginFinalizeRetryBudget");
