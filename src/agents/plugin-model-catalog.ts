...
export const PLUGIN_MODEL_CATALOG_GENERATED_BY = "grokbot-plugin-model-catalog-v1";
...
/** Detects model catalogs generated by GrokBot rather than user-authored JSON. */
