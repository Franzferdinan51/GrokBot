...
import { lowercasePreservingWhitespace } from "@grokbot/normalization-core/string-coerce";
      ...
      switch (params.provider) {
        ...
        case "vllm":
          return (
            ...
            'Set VLLM_API_KEY (any value works) or run "grokbot configure". ' +
            "See: https://docs.grokbot.ai/providers/vllm"
          );
        default:
          return undefined;
      }
