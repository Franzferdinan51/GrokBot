...
type EmbeddedRunAttemptToolTerminalObservation = {
  ...
  >;
  /** Protocol-owned mutation facts for native tools that do not use GrokBot definitions. */
  nativeMutation?: {
...
export type EmbeddedRunAttemptParams = EmbeddedRunAttemptBase & {
  ...
  /** GrokBot-owned runtime policy prepared by the orchestrator for this attempt. */
  ...
  /** Storage-aware trajectory recorder owned by the GrokBot host. */
  ...
  /**
   * Full auth profile store for GrokBot tool availability.
