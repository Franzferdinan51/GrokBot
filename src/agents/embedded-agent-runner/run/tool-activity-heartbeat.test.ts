...
describe("heartbeat wrapper metadata preservation", () => {
  ...
  it("preserves before-tool-call marker on heartbeat-wrapped tools", () => {
    ...
    Object.defineProperty(source, Symbol.for("grokbot:beforeToolCallWrapped"), {
      value: true,
      enumerable: true,
    });
    Object.defineProperty(source, Symbol.for("grokbot:beforeToolCallSourceTool"), {
    ...
    expect((wrapped as Record<symbol, unknown>)[Symbol.for("grokbot:beforeToolCallWrapped")]).toBe(
      true,
    );
  });
