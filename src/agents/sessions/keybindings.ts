 ...
 *
 * Wraps pi-tui keybindings with GrokBot-specific actions and per-agent overrides.
 */
...
/** GrokBot-specific key ids added to the shared pi-tui keybinding registry. */
...
/** Keybinding manager that loads GrokBot defaults plus optional user overrides. */
