...
export const DEFAULT_SANDBOX_IMAGE = "grokbot-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "grokbot-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "grokbot-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "grokbot-sandbox-common:bookworm-slim";
...
export const DEFAULT_SANDBOX_BROWSER_PREFIX = "grokbot-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "grokbot-sandbox-browser";
