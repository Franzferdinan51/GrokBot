...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  ...
  const base = {
    ...
    workspaceDir: "/tmp/grokbot-sandbox",
    agentWorkspaceDir: "/tmp/grokbot-workspace",
    workspaceAccess: "none",
    runtimeId: "grokbot-sbx-test",
    runtimeLabel: "grokbot-sbx-test",
    containerName: "grokbot-sbx-test",
    ...
    browser: {
      ...
      containerName: "grokbot-sbx-browser-test",
    },
