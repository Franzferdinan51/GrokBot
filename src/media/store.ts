...
import {
  ...
  extnameFromAnyPath,
  nameFromAnyPath,
} from "@grokbot/media-core/file-name";
import { detectMime, extensionForMime, normalizeMimeType } from "@grokbot/media-core/mime";
...
if (process.env.VITEST || process.env.NODE_ENV === "test") {
  (globalThis as Record<PropertyKey, unknown>)[Symbol.for("grokbot.mediaStoreTestApi")] = {
