...
export type OpenClawPluginApi = {
  ...
  registerCli: (
    ...
    opts?: {
       ...
       *
       * When descriptors cover every command exposed at `parentPath`, GrokBot
  ...
  /**
   * Register a plugin-owned node feature command group under `grokbot nodes`.
   *
  ...
  /** Register an importer for `grokbot migrate` (migration capability). */
