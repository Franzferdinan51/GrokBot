...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by GrokBot from plugin manifests, install records, and config policy. Use `grokbot plugins registry --refresh`, `grokbot plugins install/update/uninstall`, or `grokbot plugins enable/disable` instead.";
...
export type InstalledPluginIndexRecord = {
  ...
  /**
   * Package-authored grokbot.install metadata. This describes catalog/package
