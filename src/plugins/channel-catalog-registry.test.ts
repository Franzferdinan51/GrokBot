...
const ENV: NodeJS.ProcessEnv = { HOME: "/tmp/grokbot-test-home" };
let loadCase = 0;

const RECORDS: Record<string, PluginInstallRecord> = {
  weixin: {
    source: "npm",
    spec: "@tencent-weixin/grokbot-weixin@2.3.7",
    installPath:
      "/tmp/grokbot-test-home/.grokbot/npm/node_modules/@tencent-weixin/grokbot-weixin",
...
function createChannelCandidate(params: {
  ...
  return {
    ...
    source: "/tmp/grokbot-test-plugin/index.js",
    rootDir: "/tmp/grokbot-test-plugin",
    origin: params.origin ?? "global",
    packageName: "@vendor/grokbot-test-plugin",
    packageManifest: {
