...
import { resolveUnsupportedToolSchemaKeywords } from "@grokbot/ai/internal/openai";
...
// Tool-schema compat predicates moved into @grokbot/ai (agent-tools-parameter-schema);
