...
const WEB_SEARCH_DOCS_URL = "https://docs.grokbot.ai/tools/web";
  ...
  if (!needsCredential) {
    await prompter.note(
      [
        ...
        "GrokBot will enable the plugin and use it as your web_search provider.",
        `Docs: ${entry.docsUrl ?? "https://docs.grokbot.ai/tools/web"}`,
      ].join("\n"),
      "Web search",
    );
