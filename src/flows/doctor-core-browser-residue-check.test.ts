...
const residue = {
  legacyProfileDir: "/tmp/grokbot-home/browser/clawd",
  legacyUserDataDir: "/tmp/grokbot-home/browser/clawd/user-data",
  canonicalUserDataDir: "/tmp/grokbot-home/browser/grokbot/user-data",
};
...
describe("browser clawd profile residue health check", () => {
  ...
  it("reports legacy clawd profile residue through doctor lint", async () => {
    ...
    const cfg: OpenClawConfig = { browser: { profiles: { grokbot: { color: "#FF4500" } } } };
