...
/** Parse `grokbot health` flags for the route-first status family. */
...
/** Parse `grokbot status` flags without registering the full command tree. */
...
/** Parse `grokbot gateway status` RPC-only flags accepted by the fast route. */
...
/** Parse `grokbot sessions` filters for JSON/list route execution. */
...
/** Parse `grokbot agents list` display switches for route-first execution. */
...
/** Parse `grokbot config get <path>` while preserving root option handling. */
...
/** Parse `grokbot config unset <path>` and its mutation guard flags. */
...
/** Parse `grokbot models list` filters for the lightweight model catalog route. */
...
/** Parse `grokbot models status` probe controls for the route-first status path. */
...
/** Parse `grokbot channels list` display flags for the route-first list path. */
...
/** Parse `grokbot channels status` probe flags without full CLI registration. */
...
/** Parse JSON-only `grokbot plugins list` flags for plugin inventory output. */
...
/** Parse both `grokbot tasks --json` and `grokbot tasks list --json` aliases. */
...
/** Parse JSON-only `grokbot tasks audit` filters for the route-first audit path. */
