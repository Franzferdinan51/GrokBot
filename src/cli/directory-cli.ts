    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["grokbot directory self --channel slack", "Show the connected account identity."],
          [
            'grokbot directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["grokbot directory groups list --channel discord", "List available groups/channels."],
          [
            "grokbot directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.grokbot.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
