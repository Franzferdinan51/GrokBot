// Plugin state SQLite helpers persist plugin state in the GrokBot state database.
...
if (process.env.VITEST || process.env.NODE_ENV === "test") {
  (globalThis as Record<PropertyKey, unknown>)[Symbol.for("grokbot.pluginStateSqliteTestApi")] = {
