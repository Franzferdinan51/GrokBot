...
import { normalizeText } from "@grokbot/acp-core/normalize-text";
...
export { normalizeText } from "@grokbot/acp-core/normalize-text";
...
export type ConfiguredAcpBindingSpec = {
  ...
  /** Owning GrokBot agent id (used for session identity/storage). */
  agentId: string;
