...
const GENERATED_MEDIA_TASK_ACTIVITY_KEY = Symbol.for("grokbot.generatedMediaTaskActivity");
const GENERATED_MEDIA_TASK_ADMISSIONS_KEY = Symbol.for("grokbot.generatedMediaTaskAdmissions");
...
if (process.env.VITEST || process.env.NODE_ENV === "test") {
  (globalThis as Record<PropertyKey, unknown>)[
    Symbol.for("grokbot.generatedMediaTaskActivityTestApi")
