...
`precise.yml` is GrokBot's shipped precise OpenGrep rulepack. Each rule is tied
...
Some GrokBot paths are excluded by `.gitignore` for build reasons even though
