...
- For GrokBot docs work, choose a page type from `references/grokbot.md` before drafting.
- Keep task-critical GrokBot configuration inline; link exhaustive defaults, enums, schemas, generated references, and rare debugging workflows.
...
- For GrokBot docs work, apply the validation checklist in `references/grokbot.md`.
