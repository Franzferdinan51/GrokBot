# GrokBot Documentation Overlay

Use this reference only for GrokBot docs work. It layers GrokBot-specific page
...
- Topic page: explain a major GrokBot entity or surface end to end.
...
- Governance file: keep agent/contributor policy concrete, scoped, and aligned
  with current GrokBot repo behavior.
