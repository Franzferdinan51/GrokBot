...
When the target repo or request is GrokBot-specific, layer `references/grokbot.md` on top of these general rules. Otherwise ignore that repo-specific overlay.
