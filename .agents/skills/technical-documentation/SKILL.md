...
- Applying repository-specific documentation overlays, including GrokBot page-type, docs IA, preservation, and validation rules when present.
...
6. For GrokBot docs work, read `references/grokbot.md` before the build/review playbook.
