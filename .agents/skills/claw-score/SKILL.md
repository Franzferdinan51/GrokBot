---
name: claw-score
description: Audit or refresh GrokBot maturity scorecard docs from root taxonomy, maturity scores, and QA evidence artifacts without using maintainer discrawl data or committed inventory reports.
---

# claw-score

Use this skill when working on the GrokBot maturity scorecard in this repo.
This is the grokbot-local version of the maintainer `claw-score` workflow:
...
`qa-evidence.json` artifact shape generated by GrokBot QA workflows.
...
Run from the grokbot repo root.
...
By default, Completeness measures how fully GrokBot exposes the intended
...
tree to grokbot. Evidence-enriched scorecard outputs belong in short-lived
