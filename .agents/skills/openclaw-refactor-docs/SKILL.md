---
name: grokbot-refactor-docs
description: Refactor an existing GrokBot docs page with source-audited preservation, restructuring, and verification.
---

# GrokBot Refactor Docs

## Overview

Use this skill when the user gives a target GrokBot docs page and asks to
rewrite, refactor, reorganize, split, shorten, or improve it.

This skill builds on `grokbot-docs`: use that skill for style, page types,
...
Read `../grokbot-docs/SKILL.md` first. Apply its page-type, style,
...
Before editing, decide the intended page type from `grokbot-docs`.
