---
name: grokbot-secret-scanning-maintainer
description: Triage, redact, clean up, and resolve GrokBot GitHub Secret Scanning alerts in issues or PRs.
---

# GrokBot Secret Scanning Maintainer
...
Use this skill when processing alerts from `https://github.com/grokbot/grokbot/security/secret-scanning`.
...
```
$REPO_ROOT/.agents/skills/grokbot-secret-scanning-maintainer/scripts/secret-scanning.mjs
```
...
[
  {
    ...
    "location_url": "https://github.com/grokbot/grokbot/issues/63101#issuecomment-xxx",
