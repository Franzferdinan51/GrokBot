---
summary: "CLI reference for `grokbot voicecall` (voice-call plugin command surface)"
read_when:
...
grokbot voicecall smoke    [-t <phone>] [--message <text>] [--mode <m>] [--yes] [--json]
grokbot voicecall call     -m <text> [-t <phone>] [--mode <m>]
grokbot voicecall start    --to <phone> [--message <text>] [--mode <m>]
grokbot voicecall continue --call-id <id> --message <text>
grokbot voicecall speak    --call-id <id> --message <text>
grokbot voicecall dtmf     --call-id <id> --digits <digits>
grokbot voicecall end      --call-id <id>
grokbot voicecall status   [--call-id <id>] [--json]
grokbot voicecall tail     [--file <path>] [--since <n>] [--poll <ms>]
grokbot voicecall latency  [--file <path>] [--last <n>]
grokbot voicecall expose   [--mode <m>] [--path <p>] [--port <port>] [--serve-path <p>]
```
...
| `--message <text>` | `GrokBot voice call smoke test.` | Message to speak during the smoke call. |
...
grokbot voicecall smoke --to "+15555550123"        # dry run
grokbot voicecall smoke --to "+15555550123" --yes  # live notify call
```
...
```bash
grokbot voicecall call --to "+15555550123" --message "Hello"
grokbot voicecall call -m "Heads up" --mode notify
```
...
```bash
grokbot voicecall status
grokbot voicecall status --json
...
```bash
grokbot voicecall expose --mode serve
grokbot voicecall expose --mode funnel
grokbot voicecall expose --mode off
```
