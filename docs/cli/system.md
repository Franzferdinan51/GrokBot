---
summary: "CLI reference for `grokbot system` (system events, heartbeat, presence)"
read_when:
...
grokbot system event --text "Check for urgent follow-ups" --url ws://127.0.0.1:18789 --token "$OPENCLAW_GATEWAY_TOKEN"
grokbot system heartbeat enable
grokbot system heartbeat last
grokbot system presence
```
