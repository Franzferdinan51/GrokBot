...
Linux desktop, VNC rescue, Slack Web, a real GrokBot gateway, screenshots,
...
- **Mantis artifacts** - owned by the GrokBot run. Live under
...
- remote logs: `slack-desktop-command.log`, `grokbot-gateway.log`, `chrome.log`, `ffmpeg.log`
...
- `crabbox.remote_run` - sync, browser launch, GrokBot install/build or
...
remote status but Mantis copied metadata proving either the GrokBot gateway
