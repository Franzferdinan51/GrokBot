...
- Source: `WorkActivityStore` (`apps/macos/Sources/GrokBot/WorkActivityStore.swift`).
...
- Settings > Debug > "Icon override" picker:
  ...
  - `Idle`
- Stored under `UserDefaults` key `grokbot.iconOverride`; mapped to `IconState.overridden`.
