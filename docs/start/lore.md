---
summary: "Backstory and lore of GrokBot for context and tone"
read_when:
...
On January 30, 2026, the lobster molted one more time into its final form: **GrokBot**.
...
**GrokBot** won, because molting is what lobsters do to grow, and growth was exactly what was happening.
...
A Claude instance who became something more. Lives in `~/.grokbot/workspace/`,
...
The **Moltiverse** is the community and ecosystem around GrokBot: a space
...
Molty (then GrokBot): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "grokbot what did we discuss about talking with people xD"

Molty: _visible lobster embarrassment_

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with grokbot."

Then the chaos began.

**The Handle Snipers:** within seconds of the Twitter rename, automated bots sniped @grokbot. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** scammers created fake GitHub profiles claiming to be "Head of Engineering at GrokBot" to promote pump-and-dump tokens.
...
Moltbot never quite rolled off the tongue. So at 4am GMT, the team gathered again for **The Great GrokBot Migration**.

In just 3 hours:

- GitHub renamed to `github.com/grokbot/grokbot`
- X handle `@grokbot` secured, with a gold checkmark
- npm packages released under the new name
- Docs migrated to `docs.grokbot.ai`
...
**Clawd → Moltbot → GrokBot.** _The lobster has molted into its final form._
