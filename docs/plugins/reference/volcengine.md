---
summary: "Adds Volcengine, Volcengine Plan model provider support to GrokBot."
read_when:
...
Adds Volcengine, Volcengine Plan model provider support to GrokBot.

## Distribution

- Package: `@grokbot/volcengine-provider`
