---
summary: "GrokBot Anthropic Vertex provider plugin for Claude models on Google Vertex AI."
read_when:
...
GrokBot Anthropic Vertex provider plugin for Claude models on Google Vertex AI.

## Distribution

- Package: `@grokbot/anthropic-vertex-provider`
...
`/think off` or the native `/think xhigh|max` levels. GrokBot publishes its
