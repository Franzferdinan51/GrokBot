---
summary: "Adds Google, Google Gemini CLI, Google Vertex model provider support to GrokBot."
read_when:
...
Adds Google, Google Gemini CLI, Google Vertex model provider support to GrokBot.

## Distribution

- Package: `@grokbot/google-plugin`
