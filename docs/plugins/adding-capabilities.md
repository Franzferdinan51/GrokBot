---
summary: "Contributor guide for adding a new shared capability to the GrokBot plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for GrokBot core developers. If you are
...
Use this when GrokBot needs a new shared domain such as embeddings, image
