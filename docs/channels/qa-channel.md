---
summary: "Synthetic Slack-class channel plugin for deterministic GrokBot QA scenarios"
title: "QA channel"
read_when:
...
- `botUserId` - synthetic bot user id used in target grammar (default: `grokbot`).
- `botDisplayName` - display name for outbound messages (default: `GrokBot QA`).
