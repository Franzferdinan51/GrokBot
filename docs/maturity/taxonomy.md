...
summary: "Detailed reference for the product areas and checks behind the GrokBot maturity scorecard."
---
...
<Tabs>
  <Tab title="Core">
    ...
    <a className="maturity-surface-link" href="#grokbot-app-sdk">
      <span className="maturity-surface-title">GrokBot App SDK</span>
...
<AccordionGroup>
  ...
  <Accordion title="GrokBot App SDK - M2 Alpha - 6 areas">
    <a id="grokbot-app-sdk" />

    GrokBot App SDK is a distinct external app contract separate from Gateway runtime and Plugin SDK. Current scoring shows a real `@grokbot/sdk` path with gaps around public packaging, auto-discovery, approvals, helpers, and compatibility.
...
<AccordionGroup>
  ...
  <Accordion title="Linux companion app - M0 Planned - 5 areas">
    ...
    [Linux](/platforms/linux), [GrokBot](/start/grokbot), [Doctor](/gateway/doctor)
