---
summary: "How GrokBot triages, responds to, and follows up on security incidents"
...
| High     | Verified trust-boundary bypass requiring limited preconditions (for example, authenticated but unauthorized high-impact action), or exposure of GrokBot-owned sensitive credentials. |
...
- [Security policy](https://github.com/grokbot/grokbot/blob/main/SECURITY.md) — report scope and trust model.
