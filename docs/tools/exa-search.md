      ...
      exa: {
        config: {
          webSearch: {
            ...
            baseUrl: "https://api.exa.ai", // optional; GrokBot appends /search
          },
        },
      },
    },
