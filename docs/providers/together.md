...
title: "Together AI"
read_when:
  - You want to use Together AI with GrokBot
...
GrokBot bundles it as the `together` provider.
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    grokbot onboard --auth-choice together-api-key
    ```
  </Step>
...
<AccordionGroup>
  <Accordion title="Environment note">
    ...
    gateway processes. Use `~/.grokbot/.env` or `env.shellEnv` config for
  ...
  <Accordion title="Troubleshooting">
    - Verify your key works: `grokbot models list --provider together`
