...
- [Doctor](/gateway/doctor) - `grokbot doctor`: health checks, config migrations, repair steps
...
- [Environment variables](/help/environment) - where GrokBot loads env vars and precedence
...
- [GrokBot lore](/start/lore) - the story
