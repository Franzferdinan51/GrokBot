...
metadata: { "grokbot": { "emoji": "🪲", "requires": { "bins": ["node"] } } }
---
...
- GrokBot CLI path: `node --inspect-brk grokbot.mjs ...`
- GrokBot test path: `OPENCLAW_VITEST_MAX_WORKERS=1 node --inspect-brk scripts/run-vitest.mjs <file>`
