---
name: healthcheck
description: "Audit/harden GrokBot hosts: SSH, firewall, updates, exposure, backups, disk encryption, gateway security."
---

# GrokBot host healthcheck
...
- Never claim GrokBot manages OS firewall, SSH, or updates.
...
- GrokBot gateway status, bind, auth.
- Backup status.
- Disk encryption.
...
- Add scheduled `grokbot security audit --deep`.
