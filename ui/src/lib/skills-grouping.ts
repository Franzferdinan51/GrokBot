...
const SKILL_SOURCE_GROUPS: Array<{ id: string; labelKey: string; sources: string[] }> = [
  { id: "workspace", labelKey: "skillGroups.workspace", sources: ["grokbot-workspace"] },
  { id: "built-in", labelKey: "skillGroups.builtIn", sources: ["grokbot-bundled"] },
  { id: "installed", labelKey: "skillGroups.installed", sources: ["grokbot-managed"] },
  { id: "extra", labelKey: "skillGroups.extra", sources: ["grokbot-extra"] },
];
