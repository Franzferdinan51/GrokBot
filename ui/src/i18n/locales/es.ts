...
export const es: TranslationMap = {
  ...
  lazyView: {
    ...
    staleSubtitle:
      "GrokBot se actualizó en segundo plano. Recarga para obtener el panel más reciente.",
    retry: "Reintentar",
  },
  nodes: {
    pairing: {
      ...
      qrAlt: "Código QR de vinculación de GrokBot móvil",
      ...
      review: "Revisión",
      waiting:
        "Las apps móviles oficiales de GrokBot se conectan automáticamente después de escanear.",
  ...
  worktrees: {
    ...
    subtitle: "Checkouts de repositorios aislados propiedad de GrokBot.",
    cleanNow: "Limpiar ahora",
    cleanupTitle: "Limpieza",
    cleanupSubtitle:
      "GrokBot elimina periódicamente los worktrees antiguos para liberar espacio en disco. Ajusta la intensidad de la limpieza.",
  ...
  configView: {
    ...
    retry: "Reintentar",
    applyBannerText: "Guardado en grokbot.json — reinicia el gateway para aplicar.",
  ...
  subtitles: {
    ...
    config: "Editar ~/.grokbot/grokbot.json de forma segura.",
  ...
  modelSetup: {
    ...
    intro:
      "GrokBot reutiliza el acceso a IA que ya tienes: un inicio de sesión mediante CLI, una clave de API o un inicio de sesión con un proveedor.",
    ...
    access: {
      ...
      gatewayTooOld: "El Gateway está ejecutando una versión anterior de GrokBot",
    },
    candidates: {
  ...
  memoryImport: {
    ...
    confirmBackup:
      "GrokBot crea una copia de seguridad verificada previa a la importación antes de copiar la memoria.",
    ...
    subtitle:
      "Revisa la memoria consolidada de Codex y la memoria automática de Claude Code antes de copiarlas en GrokBot.",
  ...
  onboarding: {
    memoryImport: {
      ...
      body: "GrokBot encontró memoria de otros asistentes de programación. ¿Quieres importarla al espacio de trabajo de tu agente?",
      ...
      doneBody:
        "Migrados: {migrated}; omitidos: {skipped}. Puedes continuar configurando GrokBot.",
    },
  },
  mcpPage: {
  ...
  pluginsPage: {
    ...
    noInstalledBody: "Descubre un plugin destacado o busca en ClawHub para ampliar GrokBot.",
    ...
    optionalCapability: "Capacidad opcional de GrokBot.",
    enabled: "Activado",
    disabled: "Desactivado",
    available: "Disponible",
  ...
  aboutPage: {
    ...
    license: "© 2026 GrokBot Foundation — Licencia MIT.",
  ...
  skillWorkshop: {
    ...
    selfLearning: {
      ...
      pitchBody:
        "GrokBot revisa las correcciones y las ejecuciones sustanciales completadas y, a continuación, redacta propuestas de Skills para este tablero. Consume tokens adicionales en segundo plano y los borradores aparecen como propuestas pendientes.",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Pega el token de grokbot dashboard --no-open o introduce la contraseña configurada.",
        stepGenerate:
          "Si no hay token configurado, ejecuta grokbot doctor --generate-gateway-token en el host del Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard: "Ejecuta grokbot dashboard --no-open y abre la URL nueva o pega su token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Ejecuta grokbot devices list en el host del Gateway.",
        stepApproveId: "Aprueba esta solicitud: grokbot devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Vuelve a abrir el dashboard servido con grokbot dashboard para que UI y Gateway provengan de la misma instalación.",
        stepDevUi:
          "Si usas pnpm ui:dev, reconstruye o reinicia la UI de desarrollo contra el checkout actual.",
        stepRestart:
          "Reinicia el Gateway después de actualizar GrokBot para que sirva el protocolo actual.",
      },
      network: {
        ...
        stepGateway:
          "Confirma que el Gateway esté en ejecución con grokbot status u grokbot gateway run.",
        stepUrl:
          "Revisa la URL de WebSocket y usa wss:// cuando el Gateway esté detrás de HTTPS/Tailscale Serve.",
        stepDashboard:
          "Vuelve a abrir el dashboard con grokbot dashboard --no-open para copiar la URL y los detalles de autenticación actuales.",
      },
    },
  },
  chat: {
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint: "Describe qué debe hacer GrokBot y cuándo — se ejecuta según lo programado.",
    ...
    detail: {
      ...
      newSubtitle: "Describe lo que GrokBot debe hacer y luego elige cuándo se ejecuta.",
    ...
    form: {
      ...
      promptPlaceholder: "Describe lo que GrokBot debe hacer...",
      repeat: "Repetir",
