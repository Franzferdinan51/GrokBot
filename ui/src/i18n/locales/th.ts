...
export const th: TranslationMap = {
  ...
  lazyView: {
    ...
    staleSubtitle: "GrokBot ได้รับการอัปเดตในเบื้องหลัง โหลดใหม่เพื่อใช้แผงเวอร์ชันล่าสุด",
    retry: "ลองอีกครั้ง",
  },
  nodes: {
    pairing: {
      ...
      qrAlt: "คิวอาร์โค้ดสำหรับจับคู่ GrokBot mobile",
      ...
      review: "ตรวจทาน",
      waiting: "แอป GrokBot mobile อย่างเป็นทางการจะเชื่อมต่อโดยอัตโนมัติหลังจากสแกน",
  ...
  worktrees: {
    ...
    subtitle: "การ checkout คลังแยกที่เป็นของ GrokBot",
    cleanNow: "ล้างข้อมูลตอนนี้",
    cleanupTitle: "การล้างข้อมูล",
    cleanupSubtitle:
      "GrokBot จะลบ worktree เก่าเป็นระยะเพื่อเพิ่มพื้นที่ว่างในดิสก์ ปรับระดับความเข้มงวดในการล้างข้อมูลได้",
  ...
  configView: {
    ...
    retry: "ลองอีกครั้ง",
    applyBannerText: "บันทึกลง grokbot.json แล้ว — รีสตาร์ท Gateway เพื่อนำไปใช้",
  ...
  modelSetup: {
    ...
    intro:
      "GrokBot ใช้สิทธิ์เข้าถึง AI ที่คุณมีอยู่แล้วซ้ำได้ — ไม่ว่าจะเป็นการเข้าสู่ระบบ CLI, คีย์ API หรือการลงชื่อเข้าใช้กับผู้ให้บริการ",
    ...
    access: {
      ...
      gatewayTooOld: "Gateway กำลังใช้งาน GrokBot เวอร์ชันเก่า",
    },
    candidates: {
  ...
  memoryImport: {
    ...
    confirmBackup: "GrokBot จะสร้างข้อมูลสำรองก่อนนำเข้าที่ผ่านการตรวจสอบแล้ว ก่อนคัดลอกหน่วยความจำ",
    confirmImport: "นำเข้าหน่วยความจำ",
    disconnected: "เชื่อมต่อกับ Gateway เพื่อนำเข้าหน่วยความจำ",
    title: "นำเข้าหน่วยความจำของผู้ช่วย",
    subtitle:
      "ตรวจสอบหน่วยความจำรวมของ Codex และหน่วยความจำอัตโนมัติของ Claude Code ก่อนคัดลอกไปยัง GrokBot",
  ...
  onboarding: {
    memoryImport: {
      ...
      body: "GrokBot พบความจำจากผู้ช่วยเขียนโค้ดอื่น ต้องการนำเข้าไปยังพื้นที่ทำงานของเอเจนต์หรือไม่?",
      ...
      doneBody: "ย้ายแล้ว {migrated} รายการ ข้าม {skipped} รายการ คุณสามารถตั้งค่า GrokBot ต่อได้",
    },
  },
  mcpPage: {
  ...
  pluginsPage: {
    ...
    noInstalledBody: "ค้นพบปลั๊กอินแนะนำหรือค้นหา ClawHub เพื่อขยาย GrokBot",
    ...
    optionalCapability: "ความสามารถเสริมของ GrokBot",
  ...
  aboutPage: {
    ...
    license: "© 2026 GrokBot Foundation — สัญญาอนุญาต MIT",
  ...
  skillWorkshop: {
    ...
    selfLearning: {
      ...
      pitchBody:
        "GrokBot จะทบทวนการแก้ไขและการดำเนินงานสำคัญที่เสร็จสมบูรณ์ จากนั้นสร้างฉบับร่างข้อเสนอ Skills สำหรับบอร์ดนี้ โดยจะใช้โทเค็นเบื้องหลังเพิ่มเติม และฉบับร่างจะปรากฏเป็นข้อเสนอที่รอดำเนินการ",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste: "วางโทเค็นจาก grokbot dashboard --no-open หรือป้อนรหัสผ่านที่ตั้งค่าไว้",
        stepGenerate:
          "ถ้ายังไม่ได้ตั้งค่าโทเค็น ให้รัน grokbot doctor --generate-gateway-token บนโฮสต์ Gateway",
      ...
      authFailed: {
        ...
        stepDashboard: "รัน grokbot dashboard --no-open แล้วเปิด URL ใหม่หรือวางโทเค็นของ URL นั้น",
      ...
      pairing: {
        ...
        stepList: "รัน grokbot devices list บนโฮสต์ Gateway",
        stepApproveId: "อนุมัติคำขอนี้: grokbot devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "เปิด dashboard ที่เสิร์ฟอีกครั้งด้วย grokbot dashboard เพื่อให้ UI และ Gateway มาจากการติดตั้งเดียวกัน",
        stepDevUi: "ถ้าใช้ pnpm ui:dev ให้ build ใหม่หรือรีสตาร์ท UI dev กับ checkout ปัจจุบัน",
        stepRestart: "รีสตาร์ท Gateway หลังอัปเดต GrokBot เพื่อให้เสิร์ฟโปรโตคอลปัจจุบัน",
      },
      network: {
        title: "เชื่อมต่อไม่ได้",
        summary:
          "เบราว์เซอร์ไม่สามารถเชื่อมต่อ Gateway ให้เสร็จสมบูรณ์ได้ ตรวจสอบเป้าหมายและ transport ก่อนลองข้อมูลรับรองอีกครั้ง",
        stepGateway: "ยืนยันว่า Gateway กำลังทำงานด้วย grokbot status หรือ grokbot gateway run",
        stepUrl: "ตรวจสอบ WebSocket URL และใช้ wss:// เมื่อ Gateway อยู่หลัง HTTPS/Tailscale Serve",
        stepDashboard:
          "เปิด dashboard อีกครั้งด้วย grokbot dashboard --no-open เพื่อคัดลอก URL และรายละเอียด auth ปัจจุบันใหม่",
      },
    },
  },
  chat: {
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint: "อธิบายสิ่งที่ GrokBot ควรทำและเมื่อใด — มันจะทำงานตามกำหนดเวลา",
    ...
    detail: {
      ...
      newSubtitle: "อธิบายสิ่งที่ GrokBot ควรทำ แล้วเลือกเวลาที่จะให้ทำงาน",
    ...
    form: {
      ...
      promptPlaceholder: "อธิบายสิ่งที่ GrokBot ควรทำ...",
      repeat: "ทำซ้ำ",
