...
export const it: TranslationMap = {
  ...
  lazyView: {
    ...
    staleSubtitle:
      "GrokBot è stato aggiornato in background. Ricarica per visualizzare il pannello più recente.",
    retry: "Riprova",
  },
  nodes: {
    pairing: {
      ...
      qrAlt: "Codice QR di associazione di GrokBot mobile",
      ...
      review: "Revisione",
      waiting:
        "Le app mobile ufficiali di GrokBot si connettono automaticamente dopo la scansione.",
  ...
  worktrees: {
    ...
    subtitle: "Checkout di repository isolati di proprietà di GrokBot.",
    cleanNow: "Pulisci ora",
    cleanupTitle: "Pulizia",
    cleanupSubtitle:
      "GrokBot rimuove periodicamente i worktree obsoleti per liberare spazio su disco. Configura il livello di aggressività della pulizia.",
  ...
  configView: {
    ...
    retry: "Riprova",
    applyBannerText: "Salvato in grokbot.json — riavvia il gateway per applicare.",
  ...
  modelSetup: {
    ...
    intro:
      "GrokBot riutilizza l'accesso all'IA che hai già: un accesso CLI, una chiave API o l'accesso a un provider.",
    ...
    access: {
      ...
      gatewayTooOld: "Il Gateway esegue una versione precedente di GrokBot",
    },
    candidates: {
  ...
  memoryImport: {
    ...
    confirmBackup:
      "GrokBot crea un backup verificato prima dell'importazione e prima di copiare la memoria.",
    ...
    subtitle:
      "Esamina la memoria consolidata di Codex e la memoria automatica di Claude Code prima di copiarle in GrokBot.",
  ...
  onboarding: {
    memoryImport: {
      ...
      body: "GrokBot ha trovato la memoria di altri assistenti di programmazione. Importarla nell'area di lavoro del tuo agente?",
      ...
      doneBody: "Migrati: {migrated}, ignorati: {skipped}. Puoi continuare a configurare GrokBot.",
    },
  },
  mcpPage: {
  ...
  pluginsPage: {
    ...
    noInstalledBody: "Scopri un plugin in evidenza o cerca in ClawHub per estendere GrokBot.",
    ...
    optionalCapability: "Funzionalità GrokBot facoltativa.",
    enabled: "Abilitato",
    disabled: "Disabilitato",
    available: "Disponibile",
  ...
  aboutPage: {
    ...
    license: "© 2026 GrokBot Foundation — Licenza MIT.",
  ...
  skillWorkshop: {
    ...
    selfLearning: {
      ...
      pitchBody:
        "GrokBot esamina le correzioni e le esecuzioni sostanziali completate, quindi crea bozze di proposte di skill per questa bacheca. Utilizza token aggiuntivi in background e le bozze arrivano come proposte in sospeso.",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Incolla il token da grokbot dashboard --no-open oppure inserisci la password configurata.",
        stepGenerate:
          "Se non è configurato alcun token, esegui grokbot doctor --generate-gateway-token sull’host Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Esegui grokbot dashboard --no-open e apri il nuovo URL oppure incolla il suo token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Esegui grokbot devices list sull’host Gateway.",
        stepApproveId: "Approva questa richiesta: grokbot devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Riapri il dashboard servito con grokbot dashboard in modo che UI e Gateway provengano dalla stessa installazione.",
        stepDevUi:
          "Se usi pnpm ui:dev, ricompila o riavvia la UI di sviluppo contro il checkout corrente.",
        stepRestart:
          "Riavvia il Gateway dopo aver aggiornato GrokBot affinché serva il protocollo corrente.",
      },
      network: {
        ...
        stepGateway:
          "Conferma che il Gateway sia in esecuzione con grokbot status o grokbot gateway run.",
        stepUrl:
          "Controlla l’URL WebSocket e usa wss:// quando il Gateway è dietro HTTPS/Tailscale Serve.",
        stepDashboard:
          "Riapri il dashboard con grokbot dashboard --no-open per ricopiare l’URL corrente e i dettagli auth.",
      },
    },
  },
  chat: {
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint:
        "Descrivi cosa deve fare GrokBot e quando: verrà eseguito secondo la pianificazione.",
    ...
    detail: {
      ...
      newSubtitle: "Descrivi cosa deve fare GrokBot, poi scegli quando eseguirla.",
    ...
    form: {
      ...
      promptPlaceholder: "Descrivi cosa deve fare GrokBot...",
      repeat: "Ripeti",
