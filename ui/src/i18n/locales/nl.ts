...
export const nl: TranslationMap = {
  ...
  lazyView: {
    ...
    staleSubtitle:
      "GrokBot is op de achtergrond bijgewerkt. Laad opnieuw om het nieuwste paneel te zien.",
    retry: "Opnieuw proberen",
  },
  nodes: {
    pairing: {
      ...
      qrAlt: "QR-code voor koppeling met GrokBot mobiel",
      ...
      review: "Beoordeling",
      waiting: "Officiële mobiele GrokBot-apps verbinden automatisch na het scannen.",
  ...
  worktrees: {
    ...
    subtitle: "Geïsoleerde repository-checkouts beheerd door GrokBot.",
    cleanNow: "Nu opschonen",
    cleanupTitle: "Opschonen",
    cleanupSubtitle:
      "GrokBot verwijdert periodiek oude worktrees om schijfruimte vrij te maken. Stel in hoe agressief de opschoning wordt uitgevoerd.",
  ...
  configView: {
    ...
    retry: "Opnieuw proberen",
    applyBannerText: "Opgeslagen in grokbot.json — herstart de gateway om toe te passen.",
  ...
  modelSetup: {
    ...
    intro:
      "GrokBot hergebruikt AI-toegang die je al hebt — een CLI-login, een API-sleutel of een aanmelding bij een provider.",
    ...
    access: {
      ...
      gatewayTooOld: "De Gateway gebruikt een oudere versie van GrokBot",
    },
    candidates: {
  ...
  memoryImport: {
    ...
    confirmBackup:
      "GrokBot maakt een geverifieerde back-up vóór de import voordat het geheugen wordt gekopieerd.",
    ...
    subtitle:
      "Controleer het geconsolideerde geheugen van Codex en het automatische geheugen van Claude Code voordat u het naar GrokBot kopieert.",
    agent: "Doelagent",
  ...
  onboarding: {
    memoryImport: {
      ...
      body: "GrokBot heeft geheugen van andere programmeerassistenten gevonden. Wil je dit importeren in de werkruimte van je agent?",
      ...
      doneBody:
        "{migrated} gemigreerd, {skipped} overgeslagen. Je kunt doorgaan met het instellen van GrokBot.",
    },
  },
  mcpPage: {
  ...
  pluginsPage: {
    ...
    noInstalledBody: "Ontdek een uitgelichte plugin of zoek in ClawHub om GrokBot uit te breiden.",
    ...
    optionalCapability: "Optionele GrokBot-mogelijkheid.",
    enabled: "Ingeschakeld",
    disabled: "Uitgeschakeld",
    available: "Beschikbaar",
  ...
  aboutPage: {
    ...
    license: "© 2026 GrokBot Foundation — MIT-licentie.",
  ...
  skillWorkshop: {
    ...
    selfLearning: {
      ...
      pitchBody:
        "GrokBot beoordeelt correcties en omvangrijke voltooide runs en stelt vervolgens skillvoorstellen op voor dit bord. Het verbruikt extra tokens op de achtergrond en concepten verschijnen als openstaande voorstellen.",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Plak het token uit grokbot dashboard --no-open of voer het geconfigureerde wachtwoord in.",
        stepGenerate:
          "Als er geen token is geconfigureerd, voer dan grokbot doctor --generate-gateway-token uit op de Gateway-host.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Voer grokbot dashboard --no-open uit en open de nieuwe URL of plak het token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Voer grokbot devices list uit op de Gateway-host.",
        stepApproveId: "Keur deze aanvraag goed: grokbot devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Open het geserveerde dashboard opnieuw met grokbot dashboard zodat UI en Gateway uit dezelfde installatie komen.",
        stepDevUi:
          "Als je pnpm ui:dev gebruikt, bouw of herstart de dev-UI tegen de huidige checkout.",
        stepRestart:
          "Herstart de Gateway na het bijwerken van GrokBot zodat het huidige protocol wordt geserveerd.",
      },
      network: {
        ...
        stepGateway: "Bevestig dat de Gateway draait met grokbot status of grokbot gateway run.",
        stepUrl:
          "Controleer de WebSocket-URL en gebruik wss:// wanneer de Gateway achter HTTPS/Tailscale Serve staat.",
        stepDashboard:
          "Open het dashboard opnieuw met grokbot dashboard --no-open om de huidige URL en authdetails opnieuw te kopiëren.",
      },
    },
  },
  chat: {
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint: "Beschrijf wat GrokBot moet doen en wanneer — het draait volgens schema.",
    ...
    detail: {
      ...
      newSubtitle: "Beschrijf wat GrokBot moet doen en kies wanneer het wordt uitgevoerd.",
    ...
    form: {
      ...
      promptPlaceholder: "Beschrijf wat GrokBot moet doen...",
      repeat: "Herhalen",
