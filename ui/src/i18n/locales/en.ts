...
export const en: TranslationMap = {
  ...
  lazyView: {
    ...
    staleSubtitle: "GrokBot was updated in the background. Reload to get the latest panel.",
    reloading: "Reloading…",
    retry: "Retry",
  },
  nodes: {
    pairing: {
      ...
      qrAlt: "GrokBot mobile pairing QR code",
      ...
      review: "Review",
      waiting: "Official GrokBot mobile apps connect automatically after scanning.",
      help: "Pairing help",
  ...
  worktrees: {
    ...
    subtitle: "Isolated repository checkouts owned by GrokBot.",
    cleanNow: "Clean up now",
    cleanupTitle: "Cleanup",
    cleanupSubtitle:
      "GrokBot periodically removes old worktrees to free disk space. Tune how aggressively cleanup runs.",
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Cloud workers require the GrokBot runtime; {runtime} is selected.",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint: "Notifications are shown natively by the GrokBot app on this Mac.",
      ...
      nativeBlockedHint:
        "Notifications are disabled for GrokBot in macOS. Allow them in System Settings > Notifications.",
    },
    appearance: {
      theme: "Theme",
    ...
    retry: "Retry",
    applyBannerText: "Saved to grokbot.json — restart the gateway to apply.",
  ...
  modelSetup: {
    ...
    intro:
      "GrokBot reuses AI access you already have — a CLI login, an API key, or a provider sign-in.",
    ...
    access: {
      ...
      gatewayTooOld: "The Gateway is running an older GrokBot version",
    },
    candidates: {
  ...
  memoryImport: {
    ...
    confirmBackup: "GrokBot creates a verified pre-import backup before copying memory.",
    confirmImport: "Import memory",
    disconnected: "Connect to the gateway to import memory.",
    title: "Import assistant memory",
    subtitle:
      "Review Codex consolidated memory and Claude Code auto-memory before copying it into GrokBot.",
  ...
  onboarding: {
    memoryImport: {
      ...
      body: "GrokBot found memory from other coding assistants. Import it into your agent workspace?",
      ...
      doneBody: "Migrated {migrated}, skipped {skipped}. You can continue setting up GrokBot.",
    },
  },
  custodian: {
    title: "GrokBot",
    ...
    placeholder: "Message GrokBot…",
    sensitivePlaceholder: "Enter sensitive value…",
    sensitiveReply: "Sensitive reply sent",
    send: "Send",
    thinking: "GrokBot is thinking",
    earlier: "Earlier",
    requestFailed: "GrokBot could not reply. Try again.",
    connectionChanged: "The Gateway connection changed. Retry to continue this setup.",
    sessionRestarted:
      "{error} GrokBot started a fresh session; earlier messages remain for context.",
    unsupportedGateway: "Update the Gateway to continue setup with GrokBot.",
    history: {
      button: "History",
      ...
      requestFailed: "GrokBot could not load change history.",
      loadMore: "Load more",
  ...
  pluginsPage: {
    ...
    noInstalledBody: "Discover a featured plugin or search ClawHub to extend GrokBot.",
    ...
    optionalCapability: "Optional GrokBot capability.",
    enabled: "Enabled",
    disabled: "Disabled",
    available: "Available",
  ...
  appsPage: {
    heroTitle: "Take GrokBot everywhere",
    heroTagline:
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Chat, talk, approve actions, and share into GrokBot from iOS.",
      },
      android: {
        title: "Android",
        desc: "Your Android phone as a full GrokBot node — chat, camera, and Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
      ...
      wearOs: {
        title: "Wear OS",
        desc: "The Android companion extends GrokBot to your watch.",
      },
      macos: {
        title: "macOS",
      ...
      windows: {
        title: "Windows",
        desc: "The Windows companion connects your PC as an GrokBot node.",
      },
      linux: {
        title: "Linux",
      ...
      chrome: {
        ...
        desc: "Let GrokBot drive your existing Chrome — tabs, pages, and forms.",
      },
      plugins: {
        title: "Plugins & ClawHub",
        desc: "Extend GrokBot with channels, tools, and skills from the community.",
      },
    },
  },
  presence: {
  ...
  skillWorkshop: {
    ...
    selfLearning: {
      ...
      pitchBody:
        "GrokBot reviews corrections and substantial completed runs, then drafts skill proposals for this board. It spends extra background tokens and drafts arrive as pending proposals.",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Paste the token from grokbot dashboard --no-open or enter the configured password.",
        stepGenerate:
          "If no token is configured, run grokbot doctor --generate-gateway-token on the gateway host.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Run grokbot dashboard --no-open and open the fresh URL or paste its token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Run grokbot devices list on the Gateway host.",
        stepApproveId: "Approve this request: grokbot devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Reopen the served dashboard with grokbot dashboard so the UI and Gateway come from the same install.",
        stepDevUi:
          "If using pnpm ui:dev, rebuild or restart the dev UI against the current checkout.",
        stepRestart:
          "Restart the Gateway after updating GrokBot so it serves the current protocol.",
      },
      network: {
        title: "Could not connect",
        summary:
          "The browser could not complete the Gateway connection. Check the target and transport before retrying credentials.",
        stepGateway: "Confirm the Gateway is running with grokbot status or grokbot gateway run.",
        stepUrl:
          "Check the WebSocket URL and use wss:// when the Gateway is behind HTTPS/Tailscale Serve.",
        stepDashboard:
          "Reopen the dashboard with grokbot dashboard --no-open to recopy the current URL and auth details.",
      },
    },
  },
  chat: {
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint: "Describe what GrokBot should do and when — it runs on schedule.",
    ...
    detail: {
      ...
      newSubtitle: "Describe what GrokBot should do, then pick when it runs.",
    ...
    form: {
      ...
      promptPlaceholder: "Describe what GrokBot should do...",
      repeat: "Repeat",
