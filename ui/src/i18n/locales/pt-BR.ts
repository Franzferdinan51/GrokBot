...
export const pt_BR: TranslationMap = {
  ...
  lazyView: {
    ...
    staleSubtitle:
      "O GrokBot foi atualizado em segundo plano. Recarregue para obter o painel mais recente.",
    retry: "Tentar novamente",
  },
  nodes: {
    pairing: {
      ...
      qrAlt: "Código QR de pareamento do GrokBot mobile",
      ...
      review: "Revisão",
      waiting: "Os apps móveis oficiais do GrokBot se conectam automaticamente após a leitura.",
  ...
  worktrees: {
    ...
    subtitle: "Checkouts isolados de repositórios pertencentes ao GrokBot.",
    cleanNow: "Limpar agora",
    cleanupTitle: "Limpeza",
    cleanupSubtitle:
      "O GrokBot remove periodicamente worktrees antigos para liberar espaço em disco. Ajuste o nível de agressividade da limpeza.",
  ...
  configView: {
    ...
    retry: "Tentar novamente",
    applyBannerText: "Salvo em grokbot.json — reinicie o gateway para aplicar.",
  ...
  modelSetup: {
    ...
    intro:
      "O GrokBot reutiliza o acesso à IA que você já tem — um login da CLI, uma chave de API ou um login de provedor.",
    ...
    access: {
      ...
      gatewayTooOld: "O Gateway está executando uma versão mais antiga do GrokBot",
    },
    candidates: {
  ...
  memoryImport: {
    ...
    confirmBackup:
      "O GrokBot cria um backup verificado antes da importação e antes de copiar a memória.",
    ...
    subtitle:
      "Revise a memória consolidada do Codex e a memória automática do Claude Code antes de copiá-las para o GrokBot.",
  ...
  onboarding: {
    memoryImport: {
      ...
      body: "O GrokBot encontrou memórias de outros assistentes de programação. Deseja importá-las para o espaço de trabalho do seu agente?",
      ...
      doneBody:
        "Migrados: {migrated}; ignorados: {skipped}. Você pode continuar configurando o GrokBot.",
    },
  },
  mcpPage: {
  ...
  pluginsPage: {
    ...
    noInstalledBody:
      "Descubra um plugin em destaque ou pesquise no ClawHub para expandir o GrokBot.",
    ...
    optionalCapability: "Recurso opcional do GrokBot.",
    enabled: "Ativado",
    disabled: "Desativado",
    available: "Disponível",
  ...
  aboutPage: {
    ...
    license: "© 2026 GrokBot Foundation — Licença MIT.",
  ...
  skillWorkshop: {
    ...
    selfLearning: {
      ...
      pitchBody:
        "O GrokBot revisa correções e execuções substanciais concluídas e, em seguida, cria rascunhos de propostas de skills para este quadro. Ele consome tokens adicionais em segundo plano, e os rascunhos chegam como propostas pendentes.",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste: "Cole o token de grokbot dashboard --no-open ou informe a senha configurada.",
        stepGenerate:
          "Se nenhum token estiver configurado, execute grokbot doctor --generate-gateway-token no host do Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard: "Execute grokbot dashboard --no-open e abra o novo URL ou cole seu token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Execute grokbot devices list no host do Gateway.",
        stepApproveId: "Aprove esta solicitação: grokbot devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Reabra o dashboard servido com grokbot dashboard para que UI e Gateway venham da mesma instalação.",
        stepDevUi:
          "Se estiver usando pnpm ui:dev, reconstrua ou reinicie a UI de desenvolvimento com o checkout atual.",
        stepRestart:
          "Reinicie o Gateway depois de atualizar o GrokBot para que ele sirva o protocolo atual.",
      },
      network: {
        ...
        stepGateway:
          "Confirme que o Gateway está em execução com grokbot status ou grokbot gateway run.",
        stepUrl:
          "Verifique o URL de WebSocket e use wss:// quando o Gateway estiver atrás de HTTPS/Tailscale Serve.",
        stepDashboard:
          "Reabra o dashboard com grokbot dashboard --no-open para copiar novamente o URL atual e os detalhes de auth.",
      },
    },
  },
  chat: {
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint:
        "Descreva o que o GrokBot deve fazer e quando — ele executa conforme a programação.",
    ...
    detail: {
      ...
      newSubtitle: "Descreva o que o GrokBot deve fazer e escolha quando será executado.",
    ...
    form: {
      ...
      promptPlaceholder: "Descreva o que o GrokBot deve fazer...",
      repeat: "Repetir",
