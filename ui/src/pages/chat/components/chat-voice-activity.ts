...
const MICROPHONE_ACTIVITY_TAG = "grokbot-microphone-activity";
  ...
  return html`
    <div class="agent-chat__stt-interim agent-chat__talk-status" role="alert">
      ...
      ${props.onDismissError
        ? html`
            <grokbot-tooltip .content=${t("chat.composer.dismissVoiceInputError")}>
              <button
