  ...
  private renderSummary(result: SessionsDiffResult): TemplateResult {
    ...
    return html`
      <div class="session-diff__summary">
        ...
        <grokbot-tooltip .content=${t("chat.sessionDiff.refresh")}>
          <button
...
if (!customElements.get("grokbot-session-diff")) {
  customElements.define("grokbot-session-diff", SessionDiffPanel);
}

declare global {
  interface HTMLElementTagNameMap {
    "grokbot-session-diff": SessionDiffPanel;
  }
}
