...
export function renderSessionWorkspaceToggle(
  ...
  return html`
    <grokbot-tooltip .content=${`${label} (⇧⌘B)`}>
      <button
...
export function renderSessionWorkspaceRail(
  ...
  const terminalButton = sessionWorkspace.onToggleTerminal
    ? html`
        <grokbot-tooltip .content=${t("terminal.toggle")}>
          <button
            type="button"
  ...
  const browserButton = sessionWorkspace.onToggleBrowser
    ? html`
        <grokbot-tooltip .content=${t("browser.toggle")}>
          <button
            type="button"
            class="chat-workspace-rail__terminal"
  ...
  const diffButton = sessionWorkspace.onOpenDiff
    ? html`
        <grokbot-tooltip .content=${t("chat.sessionDiff.show")}>
          <button
            type="button"
  ...
  const renderPathActions = (path: string, origin: "session" | "workspace"): TemplateResult => html`
    ...
    >
      <grokbot-tooltip .content=${t("chat.workspaceFiles.preview")}>
        <button
      ...
      <grokbot-tooltip .content=${t("chat.workspaceFiles.copyPath")}>
        <button
          class="chat-workspace-rail__row-action"
          type="button"
                ...
                >
                  ...
                  >
                    ...
                    <span class="chat-workspace-rail__file-main">
                      <grokbot-tooltip .content=${file.path || file.name}>
                ...
                return html`
                  ...
                  >
                    ...
                    >
                      ...
                      >
                      <span class="chat-workspace-rail__file-main">
                        <grokbot-tooltip .content=${entry.path || entry.name}>
              ...
              return html`
                ...
                >
                  ...
                  >
                    ...
                    >
                    <span class="chat-workspace-rail__file-main">
                      <grokbot-tooltip .content=${artifact.title}>
  ...
  return html`
    <aside class="chat-workspace-rail" aria-label=${t("chat.workspaceFiles.label")}>
        ...
        <div class="chat-workspace-rail__actions">
          ...
          ${sessionWorkspace.narrowLayout
            ...
            : html`
              ...
              `}
          <grokbot-tooltip .content=${t("chat.workspaceFiles.refresh")}>
            <button
          ...
          <grokbot-tooltip .content=${`${t("chat.workspaceFiles.collapse")} (⇧⌘B)`}>
            <button
              type="button"
      ...
      ${sessionWorkspace.list?.root
        ? html`
            <grokbot-tooltip .content=${sessionWorkspace.list.root}>
