...
// because grokbot-tooltip only carries plain-text content.
      ...
      <span class="chat-tasks-preview__meta">
        ...
        ${timeMs > 0
          ? html`<span class="chat-tasks-rail__task-sep" aria-hidden="true">·</span>
              <span>
                ${active
                  ? html`<grokbot-elapsed-time .startMs=${timeMs}></grokbot-elapsed-time>`
      ...
      ${status.startedMs !== null
        ? html`
            ...
            <span class="chat-tasks-status__time" aria-hidden="true">
              <grokbot-elapsed-time .startMs=${status.startedMs}></grokbot-elapsed-time>
            </span>
