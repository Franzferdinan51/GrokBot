...
import { extractErrorCode } from "grokbot/plugin-sdk/error-runtime";
import { resolveGlobalMap } from "grokbot/plugin-sdk/global-singleton";
import { replaceManagedMarkdownBlock } from "grokbot/plugin-sdk/memory-host-markdown";
import { readRegularFile, replaceFileAtomic } from "grokbot/plugin-sdk/security-runtime";

const DREAMS_FILENAMES = ["DREAMS.md", "dreams.md"] as const;
const DEEP_START_MARKER = "<!-- grokbot:dreaming:deep:start -->";
const DEEP_END_MARKER = "<!-- grokbot:dreaming:deep:end -->";
