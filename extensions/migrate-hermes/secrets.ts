...
import { updateAuthProfileStoreWithLock } from "grokbot/plugin-sdk/provider-auth";
import {
...
async function buildOpenCodeSecretCandidates(
  ...
  // GrokBot's Copilot token profile cannot preserve OpenCode enterprise routing yet.
