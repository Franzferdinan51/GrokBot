...
import type { DiscordGuildEntry, OpenClawConfig } from "grokbot/plugin-sdk/config-contracts";
import type { ChannelSetupDmPolicy, ChannelSetupWizard } from "grokbot/plugin-sdk/setup-runtime";
import {
