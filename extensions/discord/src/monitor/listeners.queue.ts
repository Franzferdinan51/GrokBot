...
import { createSubsystemLogger, formatDurationSeconds } from "grokbot/plugin-sdk/runtime-env";

export type DiscordListenerLogger = ReturnType<
  typeof import("grokbot/plugin-sdk/runtime-env").createSubsystemLogger
>;
