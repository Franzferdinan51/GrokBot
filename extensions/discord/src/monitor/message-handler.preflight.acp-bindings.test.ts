...
import * as conversationBindingRuntime from "grokbot/plugin-sdk/conversation-binding-runtime";
...
import { testing as sessionBindingTesting } from "grokbot/plugin-sdk/conversation-runtime";
  ...
  return {
    ...createDiscordPreflightArgs({
      ...
      discordConfig: {
        ...
        import("grokbot/plugin-sdk/config-contracts").OpenClawConfig["channels"]
      >["discord"],
