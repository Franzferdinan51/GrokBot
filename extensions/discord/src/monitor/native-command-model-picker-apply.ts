...
import type { ChatCommandDefinition, CommandArgs } from "grokbot/plugin-sdk/command-auth-native";
...
import { patchSessionEntry, resolveStorePath } from "grokbot/plugin-sdk/session-store-runtime";
