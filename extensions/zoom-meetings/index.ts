  ...
  register(api: OpenClawPluginApi) {
    ...
    api.registerTool(
      (toolContext) => ({
        ...
        label: "Zoom meetings",
        description:
          "Join and manage Zoom meeting browser guests. Guest admission, tenant sign-in, and media permissions may require manual action in the GrokBot Chrome profile.",
