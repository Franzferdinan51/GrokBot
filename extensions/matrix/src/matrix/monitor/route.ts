...
import { resolveConfiguredAcpBindingRecord } from "grokbot/plugin-sdk/acp-binding-resolve-runtime";
...
import { getSessionBindingService } from "grokbot/plugin-sdk/session-binding-runtime";
