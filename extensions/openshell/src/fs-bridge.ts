...
import { root as fsRoot } from "grokbot/plugin-sdk/file-access-runtime";
import type {
  SandboxFsBridge,
  SandboxFsStat,
  SandboxResolvedPath,
} from "grokbot/plugin-sdk/sandbox";
import { createWritableRenameTargetResolver } from "grokbot/plugin-sdk/sandbox";
import { FsSafeError, isPathInside } from "grokbot/plugin-sdk/security-runtime";
...
const MATERIALIZED_SKILLS_CONTAINER_PARTS = [".grokbot", "sandbox-skills", "skills"] as const;
