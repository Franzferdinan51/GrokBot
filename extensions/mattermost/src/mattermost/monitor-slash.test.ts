...
describe("mattermost monitor slash", () => {
  ...
  it("registers deduped default and native skill commands across teams", async () => {
    ...
    resolveCallbackUrl.mockReturnValue("https://grokbot.test/slash");
    ...
    expect(firstRegistration).toEqual({
      ...
      callbackUrl: "https://grokbot.test/slash",
      commands: [
        { trigger: "ping", description: "ping" },
        {
          trigger: "oc_skill",
    ...
    expect(runtime.log).toHaveBeenCalledWith(
      "mattermost: slash commands registered (2 commands across 2 teams, callback=https://grokbot.test/slash)",
    );
  });
