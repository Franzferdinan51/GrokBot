...
import { createLoggedPairingApprovalNotifier } from "grokbot/plugin-sdk/channel-pairing";
...
import { resolvePayloadMediaUrls, sendTextMediaPayload } from "grokbot/plugin-sdk/reply-payload";
...
export const mattermostPlugin: ChannelPlugin<ResolvedMattermostAccount> = createChatChannelPlugin({
  ...
  pairing: {
    text: {
      ...
      message: "GrokBot: your access has been approved.",
