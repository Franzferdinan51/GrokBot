...
import { getSessionBindingService } from "grokbot/plugin-sdk/conversation-runtime";
import {
  createChannelDirectoryAdapter,
  createRuntimeDirectoryLiveAdapter,
} from "grokbot/plugin-sdk/directory-runtime";
import {
...
import { createComputedAccountStatusAdapter } from "grokbot/plugin-sdk/status-helpers";
import {
...
export const feishuPlugin: ChannelPlugin<ResolvedFeishuAccount, FeishuProbeResult> =
  createChatChannelPlugin({
    base: {
      ...
      auth: {
        login: async ({ cfg }) => {
          const { createClackPrompter } = await import("grokbot/plugin-sdk/setup-runtime");
          const { replaceConfigFile } = await import("grokbot/plugin-sdk/config-mutation");
