...
import type { ProviderAuthContext, ProviderAuthResult } from "grokbot/plugin-sdk/plugin-entry";
import type { ProviderAuthMethod } from "grokbot/plugin-sdk/plugin-entry";
