...
import { parseOAuthAuthorizationInput } from "grokbot/plugin-sdk/provider-oauth-runtime";
 ...
 * @param options.originator - OAuth originator parameter (defaults to "grokbot")
 */
