...
const LEFT: HarnessVariant = { id: "left", label: "Left", runtime: "grokbot" };
const RIGHT: HarnessVariant = { id: "right", label: "Right", runtime: "grokbot" };
...
describe("harness parity", () => {
  ...
  it("labels mock token estimates separately from live usage", () => {
    const sourceCell = makeCell("grokbot", {
