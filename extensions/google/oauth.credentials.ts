...
import { lowercasePreservingWhitespace } from "grokbot/plugin-sdk/string-coerce-runtime";
...
const OAUTH_CREDENTIALS_TEST_API_KEY = Symbol.for("grokbot.google.oauthCredentialsTestApi");
