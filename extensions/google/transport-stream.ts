...
} from "grokbot/plugin-sdk/provider-transport-runtime";
import {
...
type GoogleTransportApi = CanonicalGoogleTransportApi | "grokbot-google-generative-ai-transport";
...
function normalizeGoogleTransportRouteApi(
  ...
  switch (api) {
    ...
    case "grokbot-google-generative-ai-transport":
