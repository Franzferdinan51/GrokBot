...
export function scanPolicyAgentWorkspace(
  ...
  pushAgentWorkspaceEvidence(entries, {
    ...
    tools: defaultTools,
    inheritedTools: {},
    workspaceSourceBase: "oc://grokbot.config/agents/defaults",
    inheritedWorkspaceSourceBase: "oc://grokbot.config/agents/defaults",
    toolsSourceBase: "oc://grokbot.config/tools",
    inheritedToolsSourceBase: "oc://grokbot.config/tools",
  });
  ...
  list.forEach((agent, index) => {
    ...
    pushAgentWorkspaceEvidence(entries, {
      ...
      workspaceSourceBase: `oc://grokbot.config/agents/list/#${index}`,
      inheritedWorkspaceSourceBase: "oc://grokbot.config/agents/defaults",
      toolsSourceBase: `oc://grokbot.config/agents/list/#${index}/tools`,
      inheritedToolsSourceBase: "oc://grokbot.config/tools",
    });
  });
  ...
  const sandboxModeSource =
    explicitSandboxMode !== undefined
      ...
      : inheritedSandboxMode !== undefined
        ...
        : "oc://grokbot.config/agents/defaults/sandbox/mode";
    ...
    source:
      explicitWorkspaceAccess !== undefined
        ...
        : inheritedWorkspaceAccess !== undefined
          ...
          : "oc://grokbot.config/agents/defaults/sandbox/workspaceAccess",
    scope: params.scope,
