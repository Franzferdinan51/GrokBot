...
const DEFAULT_POLICY_SANDBOX_BROWSER_NETWORK = "grokbot-sandbox-browser";
...
export function scanPolicySandboxPosture(
  ...
  pushSandboxPostureEvidence(entries, {
    ...
    inheritedSandbox: {},
    sourceBase: "oc://grokbot.config/agents/defaults/sandbox",
    inheritedSourceBase: "oc://grokbot.config/agents/defaults/sandbox",
  });
  ...
  list.forEach((agent, index) => {
    ...
    pushSandboxPostureEvidence(entries, {
      ...
      sourceBase: `oc://grokbot.config/agents/list/#${index}/sandbox`,
      inheritedSourceBase: "oc://grokbot.config/agents/defaults/sandbox",
    });
  });
