...
import type { ProviderAuthContext, ProviderAuthMethod } from "grokbot/plugin-sdk/plugin-entry";
import {
  buildApiKeyCredential,
  generatePkceVerifierChallenge,
  type ProviderAuthResult,
} from "grokbot/plugin-sdk/provider-auth";
import { generateOAuthState } from "grokbot/plugin-sdk/provider-auth-runtime";
import {
      ...
      try {
        ...
        res.end(
          "<!doctype html><html><head><meta charset='utf-8'/></head>" +
            ...
            "<p>You can close this window and return to GrokBot.</p></body></html>",
        );
