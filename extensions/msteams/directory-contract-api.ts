...
import type { ChannelDirectoryAdapter } from "grokbot/plugin-sdk/channel-contract";
import { listDirectoryEntriesFromSources } from "grokbot/plugin-sdk/directory-runtime";
