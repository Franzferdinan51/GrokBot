...
import { buildCopilotIdeHeaders, COPILOT_INTEGRATION_ID } from "grokbot/plugin-sdk/provider-auth";
import { readProviderJsonArrayFieldResponse } from "grokbot/plugin-sdk/provider-http";
...
export function resolveCopilotForwardCompatModel(
  ...
  // by simply adding them to agents.defaults.models in grokbot.json — no
