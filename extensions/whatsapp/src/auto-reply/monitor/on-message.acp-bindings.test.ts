...
import type { ConfiguredBindingRouteResult } from "grokbot/plugin-sdk/conversation-binding-runtime";
...
vi.mock("grokbot/plugin-sdk/conversation-binding-runtime", () => ({
...
vi.mock("grokbot/plugin-sdk/routing", async (importOriginal) => {
  const actual = await importOriginal<typeof import("grokbot/plugin-sdk/routing")>();
  return {
    ...actual,
