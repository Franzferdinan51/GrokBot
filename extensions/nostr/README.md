...
Nostr DM channel plugin for GrokBot using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to GrokBot. It enables your bot to:
...
# Configure grokbot to use local relay
