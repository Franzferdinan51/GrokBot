...
// Xai plugin entrypoint registers its GrokBot integration.
...
import { defaultToolStreamExtraParams } from "grokbot/plugin-sdk/provider-stream-shared";
import { jsonResult } from "grokbot/plugin-sdk/provider-web-search";
import {
