/**
 * Mirrors Codex native subagent lifecycle and completion into GrokBot task
 * runtime records, with app-server history as the recovery source.
 */
import { embeddedAgentLog, formatErrorMessage } from "grokbot/plugin-sdk/agent-harness-runtime";
import {
...
import { asFiniteNumber, normalizeOptionalString } from "grokbot/plugin-sdk/string-coerce-runtime";
