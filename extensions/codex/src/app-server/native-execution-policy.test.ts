...
import type { getSessionEntry as getSessionEntryType } from "grokbot/plugin-sdk/session-store-runtime";
...
vi.mock("grokbot/plugin-sdk/session-store-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("grokbot/plugin-sdk/session-store-runtime")>();
  return {
    ...actual,
