...
import type { AgentHarnessRuntimeArtifactBinding } from "grokbot/plugin-sdk/agent-harness-runtime";
import { resolveDefaultAgentDir, type AuthProfileStore } from "grokbot/plugin-sdk/agent-runtime";
import { createDeferred } from "grokbot/plugin-sdk/extension-shared";
...
const SHARED_CODEX_APP_SERVER_CLIENT_STATE = Symbol.for("grokbot.codexAppServerClientState");
const SHARED_CODEX_APP_SERVER_CLIENT_DISPOSER = Symbol.for("grokbot.codexAppServerClientDisposer");
const CODEX_APP_SERVER_CLIENT_START_METADATA = Symbol.for(
  "grokbot.codexAppServerClientStartMetadata",
);
