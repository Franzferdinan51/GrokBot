/**
 * Mirrors Codex native subagent thread lifecycle events into GrokBot task
 * runtime rows so parent sessions can observe child progress.
 */
import type { AgentHarnessTaskRuntime } from "grokbot/plugin-sdk/agent-harness-task-runtime";
...
/** Converts a Codex child thread id into the GrokBot task-runtime run id. */
