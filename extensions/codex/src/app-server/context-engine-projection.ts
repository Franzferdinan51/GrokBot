/**
 * Projects GrokBot context-engine assemblies into Codex prompt text while
...
import { redactSensitiveFieldValue, redactToolPayloadText } from "grokbot/plugin-sdk/logging-core";
...
const CONTEXT_HEADER = "GrokBot assembled context for this turn:";
...
/** Projects assembled GrokBot context-engine messages into Codex prompt inputs. */
