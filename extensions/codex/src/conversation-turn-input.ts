...
import type { PluginHookInboundClaimEvent } from "grokbot/plugin-sdk/plugin-entry";
import { normalizeSingleOrTrimmedStringList } from "grokbot/plugin-sdk/string-coerce-runtime";
...
function extractInboundMedia(event: PluginHookInboundClaimEvent): InboundMedia[] {
  ...
  // GrokBot channels expose either local staged files or remote URLs. Keep
