...
/** Default color for the managed GrokBot browser profile. */
export const DEFAULT_OPENCLAW_BROWSER_COLOR = "#FF4500";
/** Default managed profile name shown to users. */
export const DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME = "grokbot";
/** Default browser profile selected when no profile is requested. */
export const DEFAULT_BROWSER_DEFAULT_PROFILE_NAME = "grokbot";
