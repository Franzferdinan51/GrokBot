...
import { clearPluginCommands, registerPluginCommand } from "grokbot/plugin-sdk/plugin-runtime";
import { afterEach, beforeAll, beforeEach, describe, expect, it } from "vitest";

let registerTelegramNativeCommands: typeof import("./bot-native-commands.js").registerTelegramNativeCommands;
let setActivePluginRegistry: typeof import("grokbot/plugin-sdk/plugin-test-runtime").setActivePluginRegistry;
...
describe("registerTelegramNativeCommands real plugin registry", () => {
  beforeAll(async () => {
    ({ setActivePluginRegistry } = await import("grokbot/plugin-sdk/plugin-test-runtime"));
