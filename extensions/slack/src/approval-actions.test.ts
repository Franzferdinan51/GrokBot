...
import { buildApprovalResolutionRef } from "grokbot/plugin-sdk/approval-reference-runtime";
...
describe("Slack approval actions", () => {
  ...
  it.each([
    "callback",
    "grokbot:approval:v1:not-json",
    'grokbot:approval:v1:{"approvalId":"req-1","decision":"allow-once"}',
    'grokbot:approval:v1:{"approvalId":"req-1","approvalKind":"exec","decision":"accept"}',
    'grokbot:approval:v1:{"approvalId":"req-1","approvalKind":"exec","decision":"deny","extra":true}',
