...
import { adaptScopedAccountAccessor } from "grokbot/plugin-sdk/channel-config-helpers";
import {
...
//
// `grokbot/plugin-sdk/channel-policy` is intentionally NOT lazy here —
...
const EXTENSION_SHARED_MODULE_ID = "grokbot/plugin-sdk/extension-shared";
const TARGET_RESOLVER_RUNTIME_MODULE_ID = "grokbot/plugin-sdk/target-resolver-runtime";
