...
export const SLACK_REPLY_BUTTON_ACTION_ID = "grokbot:reply_button";
export const SLACK_REPLY_LINK_ACTION_ID = "grokbot:reply_link";
export const SLACK_REPLY_SELECT_ACTION_ID = "grokbot:reply_select";
export const SLACK_CALLBACK_BUTTON_ACTION_ID = "grokbot:callback_button";
export const SLACK_CALLBACK_SELECT_ACTION_ID = "grokbot:callback_select";
export const SLACK_APPROVAL_BUTTON_ACTION_ID = "grokbot:approval_button";
export const SLACK_APPROVAL_SELECT_ACTION_ID = "grokbot:approval_select";
export const SLACK_QUESTION_BUTTON_ACTION_ID = "grokbot:question_button";
