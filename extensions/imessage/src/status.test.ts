...
import * as processRuntime from "grokbot/plugin-sdk/process-runtime";
import * as setupRuntime from "grokbot/plugin-sdk/setup";
...
vi.mock("grokbot/plugin-sdk/setup-tools", async (importOriginal) => ({
  ...(await importOriginal<typeof import("grokbot/plugin-sdk/setup-tools")>()),
  ...setupToolsMocks,
}));
