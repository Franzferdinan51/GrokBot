...
import { resolveConfiguredCapabilityProvider } from "grokbot/plugin-sdk/provider-selection-runtime";
import type { TalkEvent } from "grokbot/plugin-sdk/realtime-voice";
import {
